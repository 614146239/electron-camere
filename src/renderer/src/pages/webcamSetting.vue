<template>
  <div class="setting">
    ...
    <el-form :model="config" label-width="auto">
      ...
      <el-form-item label="摄像头窗口">
        <el-radio-group v-model="config.isCircle" class="ml-4" @change="changeShape">
          <el-radio :label="true" border>圆形</el-radio>
          <el-radio :label="false" border>正方形</el-radio>
        </el-radio-group>
      </el-form-item>
...
const changeShape = (bool): void => {
  config.isCircle = bool
  post(JSON.stringify(config))
}
const changeBorder = (value): void => {
